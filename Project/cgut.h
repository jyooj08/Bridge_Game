...
#if defined(__has_include) && __has_include("include/glfw/glfw3.h")
	#include "include/glfw/glfw3.h"		// http://www.glfw.org // using OpenGL/GLSL Core Profile 4.6
	#include "include/glad/glad.h"		// visit http://glad.dav1d.de/ to generate your own glad.h/glad.c
#elif __has_include("gles/glfw/glfw3.h")
	#include "include/GLFW/glfw3.h"	// http://www.glfw.org // using OpenGL/GLSL ES Profile 3.0 or higher
	#include "include/glad/glad.h"		// visit http://glad.dav1d.de/ to generate your own glad.h/glad.c
#endif
